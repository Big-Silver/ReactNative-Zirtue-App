...
class CreateNewAmount extends Component {
  ...
  onPressNext() {
    this.props.navigation.navigate('create_payment_request');
  }
      ...
      <Container style={styles.container}>
        ...
        <KeyboardAvoidingView style={styles.content} behavior="padding" enabled>
          <View style={styles.topView}>
            <Text style={styles.subtitle}>Set your payment request amount</Text>
...
export default connect(mapStateToProps, undefined)(CreateNewAmount);
