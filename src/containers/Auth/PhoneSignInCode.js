...
class PhoneSignInCode extends Component {
    ...
    return (
      <Container style={styles.container}>
        ...
        <Content contentContainerStyle={styles.content}>
          ...
          <Text style={styles.explain}>To finish signing in, enter the verification code sent to your profile mobile number</Text>
...
export default connect(mapStateToProps, undefined)(PhoneSignInCode);
