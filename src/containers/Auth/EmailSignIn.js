...
class EmailSignIn extends Component {
  ...
  onLogin() {
    this.props.navigation.navigate('email_signin_code');
  }
  ...
  render() {
    const { phoneNumber, password, errorType } = this.state;
    return (
...
export default connect(mapStateToProps, undefined)(EmailSignIn);
